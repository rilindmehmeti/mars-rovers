...
class Rover
  ...
  ##
  # @param coordinates [Array] coordinates of the initial position. It should be
  # represented with two elements the first one representing x coordinate,
  # the second one representing y coordinate
  # @param orientation  [String] orientation in which Rover is headed. It should
  # have 4 possible values 'E' for east, 'N' for north, 'S' for south
  # and 'W' for west.
